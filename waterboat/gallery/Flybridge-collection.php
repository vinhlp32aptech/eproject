...
<div class="site-wrap">
    ...
    <div id="content-slider">
        <div class="wrap-slider">
            ...
            <h1 class="main-title">FLYBRIDGE Collection</h1>
      ...
      <img src="../images/Flybridge-42.jpg" alt="" id="p-1">
      <div class="title-1">
        <h1>Azimut 42-42</h1>
      ...
      <img src="../images/Flybridge-50.jpg" alt="" id="p-2">
      <div class="title-2">
       <h1> Azimut 50</h1>
      ...
      <img src="../images/Flybridge-55.jpg" alt="" id="p-3">
      <div class="title-3">
         <h1> Azimut 55</h1>
      ...
      <img src="../images/Flybridge-60.jpg" alt="" id="p-4">
      <div class="title-4">
        <h1> Azimut 60</h1>
            ...
            <div class="slider">
                <div class="inset">
                    ...
                    <figure>
                        ...
                        <img src="../images/Flybridge-42.jpg" alt="" id="i-1" class="f">
                    </figure>

                    <figure>
                        <figcaption class="title-2">
                            <h1> Azimut 50</h1>
                            <p>$931.520 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

                        </figcaption>
                        <img src="../images/Flybridge-50.jpg" alt="" id="i-2" class="f">
                    </figure>

                    <figure>
                        <figcaption class="title-3">
                            <h1> Azimut 55</h1>
                            <p>$1.249.600 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

                        </figcaption>
                        <img src="../images/Flybridge-55.jpg" alt="" id="i-3" class="f">
                    </figure>

                    <figure>
                        <figcaption class="title-4">
                            <h1> Azimut 60</h1>
                            <p>$1.613.120<a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

                        </figcaption>
                        <img src="../images/Flybridge-60.jpg" alt="" id="i-4" class="f">
                    </figure>
                    ...
                    <figure>
                        <figcaption class="title-5">
                            <h1>Azimut 66</h1>
                            <p>$1.988.000 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

                        </figcaption>
                        <img src="../images/Flybridge-66.jpg" alt="" id="i-5" class="f">
                    </figure>
                </div>
            </div>
...
<!-------------------------------------------->
    ...
    <div class="block-text">
        <div class="text">
            <h1 class="serif">Flybridge yacht collection</h1>
            <br>
            <div class="text-columns"><p>"Flybridge" is the phrase indicating the highest deck of a yacht, where you can enjoy the panoramic view, enjoy the feeling of freedom, mingle and open space with the sun and the wind. Standing on the deck of your flybridge Feel like you're flying over the sea and master your luxury machine to take you further. That's why Azimut has its own collection called Flybridge. </p>
                <p>Advanced technology, superior materials and more elaborate details will create a comfortable, luxurious space and turn your yacht into a villa in the sea. Once you step onto the deck of the Flybridge yacht, you will definitely forget about everything and enjoy yourself every moment on the yacht.      </p>
                <p>Azimut Flybridge gives you the option from 40 feet to 100 feet - the most diverse family of Azimut yachts. Therefore, Flybridge is Azimut's highest sales collection and received many prestigious awards. </p>
                </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>  Size from 34 to 58 feet. Affordable price, different design, superior facilities, luxury and comes from the world's number one brand of yachts. </p
