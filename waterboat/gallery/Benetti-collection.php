...
<div class="site-wrap">
    ...
    <div id="content-slider">
        <div class="wrap-slider">
            ...
            <h1 class="main-title">Benetti Collection</h1>
      ...
      <img src="../images/Benetti/Benetti-B.YOND37M.jpg" alt="" id="p-1">
      <div class="title-1">
        <h1>Benetti-B.YOND37M</h1>
        <p>$22.910.306 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>
      </div>
    </span>

            <span id="b-2" class="th" tabindex="11">
      <img src="../images/Benetti/Benetti-CLS132.jpg" alt="" id="p-2">
      <div class="title-2">
       <h1>Benetti-CLS132</h1>
        <p>$20.951.808 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

      </div>
    </span>
            <span id="b-3" class="th" tabindex="12">
      <img src="../images/Benetti/Benetti-DEL95.jpg" alt="" id="p-3">
      <div class="title-3">
         <h1>Benetti-DEL95</h1>
        <p>$9.993.274 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

      </div>
    </span>

            <span id="b-4" class="th" tabindex="13">
      <img src="../images/Benetti/Benetti-FAST125.jpg" alt="" id="p-4">
      <div class="title-4">
        <h1>Benetti-FAST125</h1>
        <p>$19.986.549 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>
            ...
            <div class="slider">
                <div class="inset">
                    ...
                    <figure>
                        ...
                        <img src="../images/Benetti/Benetti-B.YOND37M.jpg" alt="" id="i-1" class="f">
                    </figure>
                    ...
                    <figure>
                        ...
                        <img src="../images/Benetti/Benetti-CLS132.jpg" alt="" id="i-2" class="f">
                    </figure>
                    ...
                    <figure>
                        ...
                        <img src="../images/Benetti/Benetti-DEL95.jpg" alt="" id="i-3" class="f">
                    </figure>
                    ...
                    <figure>
                        ...
                        <img src="../images/Benetti/Benetti-FAST125.jpg" alt="" id="i-4" class="f">
                    </figure>


                    <figure>
                        <figcaption class="title-5">
                            <h1>Benetti-MED116</h1>
                            <p>$16.901.549 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

                        </figcaption>
                        <img src="../images/Benetti/Benetti-MED116.jpg" alt="" id="i-5" class="f">
                    </figure>
                </div>
            </div>
    ...
    <div class="block-text">
        <div class="text">
            <h1 class="serif">Benetti yacht collection</h1>
            <br>
            <div class="text-columns"><p>The beginnings
                    Azimut Yachts came about in 1969, when the young university student Paolo Vitelli founded Azimut Srl, and began chartering sailing boats. </p>
                <p>The first steps towards success
                    In 1970 some prestigious yachting brands appointed the company to distribute their boats in Italy.
                    Azimut quickly expanded its operations: Apart from distribution, it began to design new yachts. In a joint venture with Amerglass, it designed the AZ 43’ Bali, a mass-produced fibreglass boat, which was an immediate success.   </p>
                <p>In 1985 Azimut acquired Benetti. This historical brand, based in Viareggio, had been building boats since 1873, and designed the concept of the megayacht.</p>
                <p>Azimut was now able construct its own yachts, defining new style and industry standards that would go on to revolutionise the boat building industry, such as: large frameless windows, electric seats, and walnut interiors.    </p></div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>  </p>
                    Grande is a collection of 3-story yachts, with a length of 100 feet, a maximum of 5 cabins and plenty of spacious space for passengers.
                    </p>
