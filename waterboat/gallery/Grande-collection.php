...
<div class="site-wrap">
    ...
    <div id="content-slider">
        <div class="wrap-slider">
            ...
            <h1 class="main-title">Grande Collection</h1>
    ...
    <div class="block-text">
        <div class="text">
            <h1 class="serif">Grande yacht collection</h1>
            <br>
            <div class="text-columns"><p>Grande is a collection of 3-story yachts, with a length of 100 feet, a maximum of 5 cabins and plenty of spacious space for passengers. </p>
                <p>Grande is the sum of all the advantages of each Azimut collection to best serve the needs of its owner and beyond: to create the leading position.   </p>
                <p>Bring in the most of the amenities you want on a yacht: an outdoor bar, an outdoor jacuzzi, an isolated cockpit or a spacious master cabin and a host of modern technologies and of course not to mention the talented hands of the Italians in creating this masterpiece.   </p>
                <p>Owning a Grande means you have entered the world of Super Yachts. In other words, when an owner owns a Grande, the owner's next yacht that wants to own will be a yacht created just for them alone.   </p></div>
        </div>
    </div>
