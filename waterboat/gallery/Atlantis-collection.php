        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>Mangellano is Azimut's yacht line named after the famous explorer Mangellan. For adventure and adventure lovers, the name Mangellano will immediately arouse their passion...<p><a href="../gallery/Magellano-collection.php" class="btn btn-danger py-3 px-4">Watch now</a></p>
                </div>
            </div>
        </div>
        </di
