...
<div class="site-wrap">
    ...
    <div id="content-slider">
      ...
      <img src="../images/Atlantis/Atlantis-34.jpg" alt="" id="p-1">
      <div class="title-1">
        <h1>Atlantis-34</h1>
      ...
      <img src="../images/Atlantis/Atlantis-40.jpg" alt="" id="p-2">
      <div class="title-2">
       <h1>Atlantis-40</h1>
    ...
    <span id="b-3" class="th" tabindex="12">
      <img src="../images/Atlantis/Atlantis-43.jpg" alt="" id="p-3">
      <div class="title-3">
         <h1>Atlantis-43</h1>
      ...
      <img src="../images/Atlantis/Atlantis-45.jpg" alt="" id="p-4">
      <div class="title-4">
        <h1>Atlantis-45</h1>
            ...
            <div class="slider">
                <div class="inset">
                    ...
                    <figure>
                        ...
                        <img src="../images/Atlantis/Atlantis-34.jpg" alt="" id="i-1" class="f">
                    </figure>
                    ...
                    <figure>
                        ...
                        <img src="../images/Atlantis/Atlantis-40.jpg" alt="" id="i-2" class="f">
                    </figure>
                    ...
                    <figure>
                        ...
                        <img src="../images/Atlantis/Atlantis-43.jpg" alt="" id="i-3" class="f">
                    </figure>
                    ...
                    <figure>
                        ...
                        <img src="../images/Atlantis/Atlantis-45.jpg" alt="" id="i-4" class="f">
                    </figure>
                    ...
                    <figure>
                        <figcaption class="title-5">
                            <h1>Atlantis-51</h1>
                            <p>$794.919 <a href="#"><i class="fas fa-arrow-circle-right"></i></a></p>

                        </figcaption>
                        <img src="../images/Atlantis/Atlantis-51.jpg" alt="" id="i-5" class="f">
                    </figure>
                </div>
            </div>
...
<!--END COLLECTION-->
    ...
    <div class="block-text">
        <div class="text">
            ...
            <br>
            <div class="text-columns"><p>What will the name Atlantis remind you? For us it was simply an ocean ready to explore and the Atlantis collection was born for that reason.<p>If you want to start traveling on a real yacht, beyond the reach of a canoe or motor boat, Atlantis is our collection for you.  </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p>Mangellano is Azimut's yacht line named after the famous explorer Mangellan. For adventure and adventure lovers, the name Mangellano will immediately arouse their passion...<p><a href="../gallery/Magellano-collection.php" class="btn btn-primary py-3 px-4">Watch now</a></p>
                </div>
            </div>
        </div>
        </di
