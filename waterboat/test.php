...
$start = ($page - 1) * $limit;
$result = $db->query("SELECT * FROM customers LIMIT $start, $limit");
$customers = $result->fetch_all(MYSQLI_ASSOC);
$query = "SELECT count(id) AS id FROM customers";
$result1 = $db->selectdata($query);
$custCount = $result1->fetch(PDO::FETCH_ASSOC);
